                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="row">
                            <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                <h3 class="font-weight-bold">Hoşgeldin, <?=$user->full_name?>!</h3>
                                <h6 class="font-weight-normal mb-0">Tüm sistem sorunsuz çalışıyor! <span
                                            class="text-primary">3 okunmamış bildiriminiz var!</span></h6>
                            </div>
